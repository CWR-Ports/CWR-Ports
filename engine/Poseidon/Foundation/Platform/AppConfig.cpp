...
void AppConfig::ParseCommandLine(int argc, char** argv)
{
    ...
    try
    {
        ...
        showOption(
            displayGroup->add_option("--render", _renderBackend, "Graphics backend: dummy, gl33, vulkan, gles32, auto (default: gl33)")
                ->check(CLI::IsMember({"dummy", "gl33", "vulkan", "gles32", "auto"})),
